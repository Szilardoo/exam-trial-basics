...
#### Your answer: [You have to import the random module, and then you can use every random generator function. For example: random.random(), random.randint(), random.randrange()... etc.]
